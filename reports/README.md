...
- `segment_project_space/`: generated feasibility report series and backing bundle from `scripts/explore_segment_project_space.py`; this is small enough to keep as a browsable collaborator artifact.
